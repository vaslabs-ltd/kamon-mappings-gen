package io.vaslabs.kamon.tapir.http4k.cli
...
class Http4kCli : CliktCommand(name = "kamon-config-http4k-cli") {
    ...
    val className by option("-c", "--class", help = "Fully qualified class/object name containing the routes").default("MainKt")
    ...
    override fun run() {
        ...
        val hocon = Http4kFormatter.format(routes, backend)
